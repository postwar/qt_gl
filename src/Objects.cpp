...
VertexData Objects::CreateSquare() {
	...
	vertices.TextureCoordinates[0][2].X = tx1;	vertices.TextureCoordinates[0][2].Y = ty1;
	...
	vertices.TextureCoordinates[1][2].X = tx2;	vertices.TextureCoordinates[1][2].Y = ty1;
	...
	vertices.TextureCoordinates[2][2].X = tx2;	vertices.TextureCoordinates[2][2].Y = ty2;
	...
	vertices.TextureCoordinates[3][2].X = tx1;	vertices.TextureCoordinates[3][2].Y = ty2;
